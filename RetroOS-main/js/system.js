...
function menuAction(action) {
  ...
  switch (action) {
    case "About This Mac":
      createMessageWindow(
        "About This Mac",
        `<strong>Retro OS v2.1</strong><br>Created by Ansh kumar.<br><br>An interactive operating system sandbox inspired by classic Mac OS. Enjoy your stay!`
      );
      break;
    case "System Info":
      createMessageWindow(
