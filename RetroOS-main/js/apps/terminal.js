...
const TERMINAL_USER = "Ansh Kumar";
const TERMINAL_HOST = "retro-os";
const TERMINAL_HOME_PATH = "/Users/Ansh Kumar";
...
const terminalSocialLinks = [
  ...
  },
  {
    ...
    url: "https://www.linkedin.com/in/Ansh/",
  },
  {
    key: "x",
    label: "X",
  ...
  },
  {
    ...
    url: "https://www.instagram.com/_4nsh.xe",
  },
  {
    key: "youtube",
    label: "YouTube",
...
function displayWelcomeMessage() {
  ...
  terminalOutput.innerHTML = `
    <div class="terminal-line terminal-boot">Welcome to Retro OS Terminal MADE BY ᴀɴꜱʜ v${TERMINAL_OS_VERSION}</div>
    <div class="terminal-line terminal-boot">[INFO] Type "help" to explore the shell.</div>
    <div class="terminal-line terminal-boot">[INFO] New commands: cd, cat, open, finder, mail, theme, history.</div>`;
  updateTerminalPromptPath();
...
function getDirectoryEntries(path) {
  ...
  if (path === "~/Desktop") {
    return [
      ...
      createAppEntry("Calculator.app", { opener: () => openWindow("calculator") }),
      createAppEntry("Pizza.app", { opener: () => openWindow("coffee") }),
      createUrlEntry("My Site.url", "https://guns.lol/4nsh"),
...
function formatContactLinks() {
  return `<pre><span class="terminal-info">Website:</span>  <a href="https://guns.lol/4nsh" target="_blank" rel="noopener noreferrer">abhinavkuchhal.com</a>
<span class="terminal-info">GitHub:</span>   <a href="https://github.com/ANSH2012" target="_blank" rel="noopener noreferrer">github.com/JustPratiyush</a>
<span class="terminal-info">LinkedIn:</span> <a href="https://www.linkedin.com/in/Ansh/" target="_blank" rel="noopener noreferrer">linkedin.com/in/abhinav-kuchhal</a>
<span class="terminal-info">X:</span>        <a href="https://guns.lol/4nsh" target="_blank" rel="noopener noreferrer">x.com/JustPratiyush</a>
<span class="terminal-info">YouTube:</span>  <a href="https://www.youtube.com/@ansh18" target="_blank" rel="noopener noreferrer">youtube.com/@abhinavkuchhal</a></pre>`;
}
